...
public class CanvasRenderer {
    ...
    public void refreshLabels() {
        // Если у вас есть текстовые подписи на Canvas (оси, легенда),
        // здесь можно вызвать draw() для их обновления
        // Пример: перерисовка подписей осей с учётом новой локали
        draw();
    }
}